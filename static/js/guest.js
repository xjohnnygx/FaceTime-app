        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    _a = data.type;
                    switch (_a) {
                        case "answer": return [3 /*break*/, 1];
                        case "candidate": return [3 /*break*/, 3];
                    }
                    return [3 /*break*/, 5];
                case 1: return [4 /*yield*/, peerConnection.setRemoteDescription(data.answer)];
                case 2:
                    _b.sent();
                    return [3 /*break*/, 6];
                case 3: return [4 /*yield*/, peerConnection.addIceCandidate(data.candidate)];
                case 4:
                    _b.sent();
                    return [3 /*break*/, 6];
